...
function Color.ParseHtmlString(str)
  local ok,color = CS.UnityEngine.ColorUtility.TryParseHtmlString(str)
  return color
end

function Color.ToHtmlStringRGB(color)
  return CS.UnityEngine.ColorUtility.ToHtmlStringRGB(color)
end
